  ...
  return (
    <section className="temple-section temple-section--immersive">
      <Reveal
        variant="fade-up"
        duration={1.2}
        className="temple-model temple-model--immersive"
      >
        <TempleCanvas
          modelUrl={`${import.meta.env.BASE_URL}models/chilancho/model.glb`}
      ...
      <div className="temple-immersive-copy">
        ...
        <Reveal variant="slide-right" delay={0.2} as="p">
          ...
          smaller chaityas, its inscriptions pointing back to the medieval
          period. It remains a quiet, active site of Buddhist devotion alongside
          the town's Hindu temples — two traditions sharing one hill.
        </Reveal>
      </div>
    </section>
  );
